...
import  {creatMarkup} from "./.helpers";
    ...
    const renderAnswers = (answer)=>{
        return answer.map((
            ...
            <Paper key={question} className={classes.paper}>
                ...
                <span dangerouslySetInnerHTML={creatMarkup(question)}/>
                ...
                {isCorrect? (
                    ...
                    ${classes.isCorrect}`}>
                        <Check/>
                        <span className={classes.answer} dangerouslySetInnerHTML={creatMarkup(correctAnswer)}/>
                    ...
                    <Typography variant="h3" color="secondary" className={classes.answer}>
                        <Close/>
                        <span className={classes.answer} dangerouslySetInnerHTML={creatMarkup(wrongAnswer)}/>
